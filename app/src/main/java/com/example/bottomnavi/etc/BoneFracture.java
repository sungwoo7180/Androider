...
public class BoneFracture extends Fragment {
    private View view;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.bonefracture, container, false);
        ...
        activity.getSupportActionBar().setTitle("골절"); // 툴바 제목 설정
