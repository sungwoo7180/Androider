...
public class ElectricShock extends Fragment {
    private View view;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.electricshock, container, false);
        ...
        activity.getSupportActionBar().setTitle("감전"); // 툴바 제목 설정
