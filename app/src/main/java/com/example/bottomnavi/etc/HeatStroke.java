...
public class HeatStroke extends Fragment {
    private View view;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.heatstroke, container, false);
        ...
        activity.getSupportActionBar().setTitle("심장발작(급성 심근경색)"); // 툴바 제목 설정
