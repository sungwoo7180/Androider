...
public class Dehydration extends Fragment {
    private View view;

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.dehydration_frag1, container, false);
        ...
        activity.getSupportActionBar().setTitle("탈수 응급처치"); // 툴바 제목 설정
